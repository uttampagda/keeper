...
function displayCart() {
  ...
  document.getElementById('pl').innerHTML = cartArray;
  document.getElementById('tt').innerHTML = shoppingCart.totalCart();
  document.getElementsByName('product_list').value = cartArray;
  document.getElementsByName('total').value = shoppingCart.totalCart();
}
